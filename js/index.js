$(document).ready(function () {
  ...
  $('.next').click(function () {
    ...
    if (project_count == 1) {
      ...
      $('.project_content').text('my project for webpages.')
    } else if (project_count == 2) {
      $('.project_name').text('Template');
      $('.project_content').text('Examples')
    } else if (project_count == 3) {
      $('.project_name').text('Example of things');
      $('.project_content').text('Things u have to know');
    } else if (project_count == 4) {
      $('.project_name').text('Techpro');
      $('.project_content').text('Technical programing languages have to be learned')
